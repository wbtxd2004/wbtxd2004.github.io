...
layout: post
category: Python
title:  Python学习笔记-基础篇-[2]Python变量和基本类型
...
本篇主要介绍了Python的基本使用和基本的几种数据类型。更加复杂一些的数据类型会在之后笔记中单独纪录。
...
<img src="{{site.baseurl}}/images/post/2016-03-25/print.jpg" width="600" alt=""/>
...
<img src="{{site.baseurl}}/images/post/2016-03-25/val1.jpg" width="100" alt=""/>

执行b = a，解释器创建了变量 b，并把b指向 a 指向的字符串'ABC'：

<img src="{{site.baseurl}}/images/post/2016-03-25/val2.jpg" width="100" alt=""/>

执行a = 'XYZ'，解释器创建了字符串'XYZ'，并把a的指向改为'XYZ'，但b并没有更改：

<img src="{{site.baseurl}}/images/post/2016-03-25/val3.jpg" width="100" alt=""/>
